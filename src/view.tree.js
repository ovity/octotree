...
TreeView.prototype.show = function(repo, token) {
  ...
  function fetchData(node, success) {
    ...
    self.adapter.fetchData({ repo: repo, token: token, node: recursiveLoad ? null : selectedNode}, function(err, treeData) {
...
TreeView.prototype.syncSelection = function() {
  ...
  // e.g. convert ["lib/controllers"] to ["lib", "lib/controllers"]
